...
- `sit merge <branch>` — fast-forward when possible; otherwise file-level 3-way merge. Clean merges auto-commit with two parents; conflicts are reported per-file and require manual resolution.
